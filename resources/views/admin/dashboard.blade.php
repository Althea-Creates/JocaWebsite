  ...
  <div class="content-wrapper">
    ...
    <aside class="control-sidebar control-sidebar-dark">
        <div class="p-3">
            ...
            <!-- Add options like toggles or form elements -->
            <div class="form-check">
            <input type="checkbox" class="form-check-input" id="setting1">
            <label class="form-check-label" for="setting1">Enable Dark Mode</label>
            </div>
        
            <div class="form-check">
            <input type="checkbox" class="form-check-input" id="setting2">
            <label class="form-check-label" for="setting2">Enable Notifications</label>
            </div>
        
            <button class="btn btn-info btn-block mt-3">Save Settings</button>
        </div>
    </aside>
    <!-- /.control-sidebar -->
  </div>
